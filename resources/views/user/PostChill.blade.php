    ...
    <div class="about-area2 gray-bg pt-60 pb-60">
        <div class="container">
                ...
                <div class="col-lg-8">
                                ...
                                <div class="col-xl-12">
                                    <div class="section-tittle">
                                        <h4>
                                            ...
                                            @endisset
                                            @isset($PostName)
                                            /<a href="/PostChill/{{ $PostName }}/{{ $postChilldName }}">{{ $postChilldName }}</a>   
                                            @endisset
                                        </h4>
                                    </div>
                                </div>
                    ...
                    <user-comment post_id="{{ $PostChillId }}" blog_id=""/>
                    </div>
                            ...
                            <div class="single-wrap">
                                <nav aria-label="Page navigation example">
                                    ...
                                    <li class="page-item"><a class="page-link" href="{{ $Posts->previousPageUrl() }}">
                                        ...
                                        <li class="page-item active"><a class="page-link" href="/Post/{{ $Posts->lastPage() }}">trang cuối : {{ $Posts->lastPage() }}</a></li>
