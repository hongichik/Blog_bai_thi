                            ...
                            <div class="row justify-content-between align-items-end mb-15">
                                <div class="col-xl-12">
                                    <div class="section-tittle mb-30">
                                        <h4>
                                            <a href="/">Home</a>
                                            /<a href="/Search?searchName={{ $SearchName }}">Tìm kiếm - {{ $SearchName }}</a>   
                                        </h4>
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <div class="col-xl-6 col-lg-6 col-md-6">
                                                        <div class="whats-news-single mb-40 mb-40">
                                                            ...
                                                            <div class="whates-caption whates-caption2">
                                                                <h4><a href="/Post/{{ $Post->name }}"> {{ $Post->name }}</a></h4>
                        ...
                        <div class="col-xl-12">
                            <div class="single-wrap">
                                <nav aria-label="Page navigation example">
                                    ...
                                    <li class="page-item"><a class="page-link" href="{{ $Posts->previousPageUrl() }}&searchName={{ $SearchName }}">
                                        <!-- SVG icon -->
                                    ...
                                    <li class="page-item"><a class="page-link" href="{{ $Posts->nextPageUrl() }}&searchName={{ $SearchName }}">
                                        <!-- SVG iocn -->
