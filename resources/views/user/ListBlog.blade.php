                                                    ...
                                                    <div class="col-xl-6 col-lg-6 col-md-6">
                                                        <div class="whats-news-single mb-40 mb-40">
                                                            ...
                                                            <div class="whates-caption whates-caption2">
                                                                <h4><a href="/Blog/{{ $Post->name }}"> {{ $Post->name }}</a></h4>
                        ...
                        <div class="col-xl-12">
                            <div class="single-wrap">
                                <nav aria-label="Page navigation example">
                                    ...
                                    <li class="page-item"><a class="page-link" href="{{ $ListBlog->previousPageUrl() }}">
                                        <!-- SVG icon -->
                                        ...
                                        <li class="page-item active"><a class="page-link" >Trang hiện tại : {{ $ListBlog->currentPage() }}</a></li>
                                        <li class="page-item active"><a class="page-link" >trang cuối : {{ $ListBlog->lastPage() }}</a></li>
                                    <li class="page-item"><a class="page-link" href="{{ $ListBlog->nextPageUrl() }}">
                                        <!-- SVG iocn -->
